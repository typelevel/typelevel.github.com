{%
  laika.title: GSoC AI Policy
  ai-tab.class: bulma-is-active
%}
...
1. **Demonstrate ownership of your code**, no matter how you wrote it. This means understanding how it works and being capable of explaining that and also creating and performing tests to confirm that it works correctly, both for yourself and for your collaborators. It is okay to ask for help!

2. ***Never* use AI to generate descriptions for PRs or issues.** Similarly, please do not use AI to write your GSoC proposal or other communications such as email and Discord messages. The purpose of writing in these contexts is to organize your thoughts and directly communicate your ideas, not to craft a "polished" document. However, you may use AI to translate between English and another (natural) language.

3. **Always communicate when you have used AI** to write code, typically in your PR description. It is also helpful to explain where and how you used it, such as by including any prompts.
