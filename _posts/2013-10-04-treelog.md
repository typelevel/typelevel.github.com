...
> how can we accurately audit everything that happens to a trade as it travels through our system?
...
Treelog resolves these issues by making the log itself a tree, reflecting the computational tree it logs. It achieves this by applying a couple of ideas from the [Typeclassopedia](http://www.haskell.org/wikiupload/e/e9/Typeclassopedia.pdf): the Writer Monad, a Monad Transformer, and a cunning Monoid.
...
We need a mighty [Monad Transformer](http://debasishg.blogspot.co.uk/2011/07/monad-transformers-in-scala.html), we need EitherT!
