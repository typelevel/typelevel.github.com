...
when working with the audit later. For our trading system, that was a set of trade keys that were effected by the process which was needed for further work.
