...
Note that originally we simply used an `Option[String]` rather than this implementation. But because we needed to carry extra information we came up with LogTreeLabel.
