...
// res2: Random[(Int, Int)] = Random@1e0fc322
```
...
List()
List(-3)
List(-3, -2, -1, -8, 8, -4, -4, -5, -8)
List(-8, 8, 3, 3, -6)
List(-10, 9, -8)
List(-8, -7, -1, 7, -5, 10, -10)
List(8, -6, 4, 7)
List(-1, -3)
...
// fracGen: Gen[Frac] = Gen$$anon$2@2973494
...
// propReflexivity: Prop = $anon$1@6eac046c
```
