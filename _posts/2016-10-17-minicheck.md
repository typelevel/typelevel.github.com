...
// res2: Random[(Int, Int)] = Random@729adc8d
```
...
List()
List(3, -9, -7, -6, 5, -1)
List(-6, -1, -8, -6, 4, 7, 0, 5)
List(6, 2, 9, -7, -9, 1, 3, 1, -5, -6)
List(0, 0, 9, -1, 2)
List(10, -1, -6, -10, -1, -1, -6)
List(9)
List(7)
List(-6, -6, 7, -9, -2, -2, -3)
...
// fracGen: Gen[Frac] = Gen$$anon$2@a42f6dd
...
// propReflexivity: Prop = $anon$1@4d3ebfb7
```
