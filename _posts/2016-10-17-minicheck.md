...
// res2: Random[(Int, Int)] = Random@4fbfd782
```
...
// fracGen: Gen[Frac] = Gen$$anon$2@4ff1ab12
...
// propReflexivity: Prop = $anon$1@92ff745
```
...
scala> check { (x: Int) => (y: Int) =>
     |   x + y == x * y
     | }
✗ Property failed with counterexample: (0, -3)
```
