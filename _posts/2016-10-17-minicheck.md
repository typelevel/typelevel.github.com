...
// res2: Random[(Int, Int)] = Random@2c172ee2
```
...
List(-9, 0, -9, 1, 9, 9, 5, -4, -10)
List(10, -2, -1, 4, -4, -1, 7, 0, -6, -6)
List(1, 8, -1, -8, 10, 8, -3)
List(-10)
List(9, -9, 8, 4)
List(-5)
List(2, -6, 9, -6, 2, -4, 10, 7)
List(-8, 7, -7)
List(-8, 1, -9, 4, 6, -1, -10)
List(2, -3, -10, 10, -9, -4)
...
// fracGen: Gen[Frac] = Gen$$anon$2@5a36d633
...
// propReflexivity: Prop = $anon$1@6378dd44
```
