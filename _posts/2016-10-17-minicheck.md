...
// res2: Random[(Int, Int)] = Random@664fd142
```
...
List()
List(9, -5, -3, 7, 0, -1, -1, -3, -8, 3)
List(-10, -2, -7, 5, 3, -3, -4, 8, -6)
List(9, -4, 10, 10, 4)
List(7)
List(-8, -4, -4, 3)
List()
List(-6, 0, -8)
List(7, -9, -9, -3, -10, 1, 0, -3, 10)
List(-2, 6, -10, -9, -9, -2, 4, -3)
...
// fracGen: Gen[Frac] = Gen$$anon$2@417da6b0
...
// propReflexivity: Prop = $anon$1@226bf
```
